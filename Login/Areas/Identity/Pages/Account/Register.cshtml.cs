...
namespace Login.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            [Required]
            [StringLength(100, ErrorMessage = "The full name field should have 255 characters long.")]
            public string FullName { get; set; }

            [Required]
            [StringLength(100, ErrorMessage = "The address field should have 255 characters long.")]
